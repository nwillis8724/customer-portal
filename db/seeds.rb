...
# Admin.create(username: 'Noah', password: 'password123', position: 'Programmer')
# Admin.create(username: 'Junior', password: 'raynorblue2', position: 'Manager')

# # # Seed data for jobs
# Job.create(address: '123 Main St, Glencoe', date_of_install: '01/15/2023', access_code: '123MSGCS', admin_id: 1)
# Job.create(address: '456 Oak Ave, Winnetka', date_of_install: '02/01/2023', access_code: '456OAWKS', admin_id: 2)
# Job.create(address: '789 Elm Ln, Kennilworth', date_of_install: '03/10/2023', access_code: '789ELKWS', admin_id: 1)
# Job.create(address: '321 Maple Dr, North Field', date_of_install: '04/05/2023', access_code: '321MDNFS', admin_id: 2)
# Job.create(address: '306 Leitch Ave, La Grange', date_of_install: '04/15/2023', access_code: '306LALGW', admin_id: 1)
